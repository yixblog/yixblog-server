...
import cn.yixblog.businesses.articles.core.IArticleStorage;
import cn.yixblog.businesses.articles.storage.datafix.ArticleQueryJSON;
...
public class ArticleStorage extends SqlSessionDaoSupport implements IArticleStorage {
    ...
    public JSONObject getUserTags(int userId) {
        JSONObject res = new JSONObject();
        List<String> tags =getSqlSession().getMapper(ArticleMapper.class).getUserTags(userId);
        res.put("tags", tags);
