package cn.yixblog.businesses.files.storage;

import cn.yixblog.businesses.files.core.IImageListStorage;
...
public class ImageListStorage extends SqlSessionDaoSupport implements IImageListStorage {
    ...
    public List<String> listAllImages(int userid) {
        ImageMapper mapper =getSqlSession().getMapper(ImageMapper.class);
