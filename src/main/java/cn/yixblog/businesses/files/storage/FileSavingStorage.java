...
public class FileSavingStorage extends SqlSessionDaoSupport implements IFileSavingStorage {
    ...
    private void saveFileToDatabase(String url, int userId) {
        ImageMapper imageMapper =getSqlSession().getMapper(ImageMapper.class);
