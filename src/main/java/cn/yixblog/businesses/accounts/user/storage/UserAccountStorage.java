package cn.yixblog.businesses.accounts.user.storage;
...
public class UserAccountStorage extends SqlSessionDaoSupport implements IUserAccountStorage {
    ...
    public JSONObject doForceChangePassword(String resetCode, String newPwd) {
        ...
        String pwdMd5 = YixStringUtils.createPwdMd5(bean.getUid(), newPwd);
        bean.setPwd(pwdMd5);
    ...
    public JSONObject doChangePwd(int id, String oldPwd, String newPwd) {
        ...
        String oldPwdMd5 = YixStringUtils.createPwdMd5(account.getUid(), oldPwd);
        if (!oldPwdMd5.equals(account.getPwd())) {
            setResult(res, false, "旧密码不匹配");
            return res;
        }
        String pwdMd5 = YixStringUtils.createPwdMd5(account.getUid(), newPwd);
    ...
    public JSONObject editUser(int id, String pwd, String nick, String email, String sex, String avatar) {
        ...
        if (pwd != null) {
            String pwdMd5 = YixStringUtils.createPwdMd5(account.getUid(), pwd);
            account.setPwd(pwdMd5);
        }
        if (nick != null) {
            account.setNick(nick);
