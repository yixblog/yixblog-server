...
public class AdminCharacterStorage extends SqlSessionDaoSupport implements IAdminCharacterStorage {
    ...
    public List<JSONObject> queryAllCharacters() {
        CharacterMapper characterMapper =getSqlSession().getMapper(CharacterMapper.class);
