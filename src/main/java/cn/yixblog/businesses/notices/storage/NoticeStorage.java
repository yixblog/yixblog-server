package cn.yixblog.businesses.notices.storage;

import cn.yixblog.businesses.notices.core.INoticeStorage;
import cn.yixblog.dao.beans.NoticeBean;
import cn.yixblog.dao.mappers.NoticeMapper;
...
public class NoticeStorage extends SqlSessionDaoSupport implements INoticeStorage {
    ...
    public JSONObject queryNotices(int page, int pageSize) {
        NoticeMapper noticeMapper =getSqlSession().getMapper(NoticeMapper.class);
    ...
    public JSONObject saveNotice(String title, String content) {
        NoticeMapper mapper =getSqlSession().getMapper(NoticeMapper.class);
