...
public class ArticleController {
    ...
    public JSONObject listArticlesByJSON(@RequestParam(required = false, value = "keywords[]") String[] keywords, @RequestParam(required = false, defaultValue = "") String startDate,
